...
function init() {
  ...
  function fetchVideoFromNetwork(video) {
    ...
    let mp4Blob = fetch('https://mdn.github.io/learning-area/javascript/apis/client-side-storage/indexeddb/video-store/videos/' + video.name + '.mp4').then(response =>
      response.blob()
    );
    let webmBlob = fetch('https://mdn.github.io/learning-area/javascript/apis/client-side-storage/indexeddb/video-store/videos/' + video.name + '.webm').then(response =>
      response.blob()
    );
